...
public final class Constants {
    ...
    public static final String CLIENT_ENABLE_SESSION_CREATION = "sessionCreationEnabled";
    ...
    public static final String SERVER_ENABLE_SESSION_CREATION = "sessionCreationEnabled";
