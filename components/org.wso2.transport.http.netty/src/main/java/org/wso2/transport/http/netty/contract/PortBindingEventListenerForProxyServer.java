...
/**
 * An event listener to listen to port binding/unbinding events related to proxy listener.
 */
public interface PortBindingEventListenerForProxyServer {
     ...
     *
     * @param serverConnectorId The ID of the proxy server connecter which just started.
     */
     ...
     *
     * @param serverConnectorId The ID of the proxy server connecter which just stopped.
     */
