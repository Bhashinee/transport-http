...
public interface ProxyServerConnectorFuture {
    ...
    void setPortBindingEventListener(PortBindingEventListenerForProxyServer portBindingEventListenerForProxyServer);
